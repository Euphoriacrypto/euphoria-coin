...
static const uint256 hashGenesisBlock("0x000003b2c962fb0b0ee1d90f280e8d292c8a299177b067bd885ce2042fac1cb9");
static const uint256 hashGenesisBlockTestNet("0x000003b2c962fb0b0ee1d90f280e8d292c8a299177b067bd885ce2042fac1cb9");
...
public:
    ...
    {
        // Euphoria: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Euphoria: get transaction coin age
...
public:
    ...
    // Euphoria: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Euphoria: two types of block: proof-of-work or proof-of-stake
    ...
    // Euphoria: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Euphoria: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Euphoria: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Euphoria: block index flags
    enum  
    {
